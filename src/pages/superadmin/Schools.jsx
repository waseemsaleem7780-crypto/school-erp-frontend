                            ...
                            {setupMode === 'full' && !editingId && (
                                <div>
                                    ...
                                    <form onSubmit={handleFullSetup} style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px' }}>
                                        <div>
                                            <label style={labelStyle}>School Name *</label>
                                            <input type="text" value={fullForm.name} onChange={(e) => setFullForm({ ...fullForm, name: e.target.value })} style={inputStyle} required />
                                        </div>
                                        <div>
                                            <label style={labelStyle}>Subdomain *</label>
                                            <input type="text" value={fullForm.subdomain} onChange={(e) => setFullForm({ ...fullForm, subdomain: cleanSubdomain(e.target.value) })} style={inputStyle} required />
                                        </div>
                                        <div>
                                            <label style={labelStyle}>Admin Name *</label>
                                            <input type="text" value={fullForm.admin_name} onChange={(e) => setFullForm({ ...fullForm, admin_name: e.target.value })} style={inputStyle} required />
                                        </div>
                                        <div>
                                            <label style={labelStyle}>Admin Email *</label>
                                            <input type="email" value={fullForm.admin_email} onChange={(e) => setFullForm({ ...fullForm, admin_email: e.target.value })} style={inputStyle} required />
                                        </div>
                                        <div>
                                            <label style={labelStyle}>Admin Password *</label>
                                            <input type="text" value={fullForm.admin_password} onChange={(e) => setFullForm({ ...fullForm, admin_password: e.target.value })} style={inputStyle} required minLength={8} />
                                        </div>
                                        <div>
                                            <label style={labelStyle}>Phone</label>
                                        ...
                                        <div style={{ gridColumn: '1 / -1', marginTop: '12px' }}>
                                            ...
                                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '16px' }}>
                                                <div>
                                                    ...
                                                    <input type="number" value={fullForm.num_classes} onChange={(e) => setFullForm({ ...fullForm, num_classes: parseInt(e.target.value) || 10 })} min={1} max={20} style={inputStyle} />
                                                </div>
                                                <div>
                                                    <label style={labelStyle}>Sections/Class</label>
                                                    <input type="number" value={fullForm.num_sections} onChange={(e) => setFullForm({ ...fullForm, num_sections: parseInt(e.target.value) || 3 })} min={1} max={5} style={inputStyle} />
                                                </div>
                                                <div>
                                                    <label style={labelStyle}>Teachers</label>
                                                    <input type="number" value={fullForm.num_teachers} onChange={(e) => setFullForm({ ...fullForm, num_teachers: parseInt(e.target.value) || 30 })} min={1} max={100} style={inputStyle} />
                                                </div>
                                                <div>
                                                    <label style={labelStyle}>Students</label>
                                                    <input type="number" value={fullForm.num_students} onChange={(e) => setFullForm({ ...fullForm, num_students: parseInt(e.target.value) || 100 })} min={1} max={1000} style={inputStyle} />
                                                </div>
                                            </div>
                                        </div>
