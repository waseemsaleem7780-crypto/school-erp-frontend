...
const StudyMaterial = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setMessage({
                type: 'error',
                text: error.response?.data?.detail || 'Failed to upload'
            });
        } finally {
            setLoading(false);
        }
                ...
                <div style={{
                    ...
                    <form onSubmit={handleSubmit} style={{
                        ...
                        <div>
                            ...
                            <select
                                value={form.class_id}
                                onChange={(e) => setForm({ ...form, class_id: e.target.value, subject_id: '', section_id: '' })}
                        ...
                        <div style={{ gridColumn: '1 / -1' }}>
                            ...
                            <input
                                ...
                                placeholder="/uploads/maths_ch1.pdf or https://..."
                                style={{ width: '100%', padding: '12px 14px', fontSize: '14px', border: '2px solid #e2e8f0', borderRadius: '8px', outline: 'none', boxSizing: 'border-box' }}
                                required
                            />
                        </div>
                ...
                {materials.length === 0 ? (
                    ...
                    materials.map((m) => (
                        <div key={m.id} style={{
                            ...
                            boxShadow: '0 4px 20px rgba(0,0,0,0.08)', borderTop: '4px solid #667eea',
                        }}>
